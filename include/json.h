...
int json_integer(const json *);
unsigned int json_real(const json *);
...
json *json_new_integer(const char *, int);
json *json_new_real(const char *, unsigned int);
json *json_new_double(const char *, double);
json *json_new_number(const char *, double);
...
json *json_set_integer(json *, int);
json *json_set_real(json *, unsigned int);
